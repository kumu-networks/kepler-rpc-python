...
print("start {} stop {} step {}".format(startfreq, stopfreq, freqstep))

boxcal_format = 2

flashdata_box = struct.pack('<iBBBBffddd', 0x554d554b, boxcal_format, box_hwver, variantm, serialm, 25., 25., startfreq, stopfreq, freqstep)
print(flashdata_box)
